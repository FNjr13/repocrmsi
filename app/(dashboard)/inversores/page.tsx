...
export const metadata = { title: 'Inversores · SI CRM' }
    ...
    <div className="flex flex-col h-full">
      <div className="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Inversores & Compradores</h1>
            <p className="text-xs text-gray-500">Gestión de relaciones con compradores, inversores y brokers</p>
          </div>
        </div>
      </div>
